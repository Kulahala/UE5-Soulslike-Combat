...
- [ ] **TODO-04B-B: Bow Presentation And World Pickup v1**
  Prerequisite: `TODO-04B-A2` is validated, the prepared-projectile activation/refund risk below is resolved, and a legal DarkKnight-compatible bow mesh plus aim/release animations are selected. Author the visible bow, visible arrow, persistent `TestMap` bow and 20-arrow bundle pickups, permanent loaded-arrow HUD, and aim-only dot reticle. Do not substitute sword animations as a final bow presentation.
